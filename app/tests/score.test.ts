...
describe('score', () => {
  ...
  it('mistakes and hints reduce score and cancel the flawless bonus', () => {
    const clean = computeScore({ difficulty: 'hard', timeSeconds: 99999, mistakes: 0, hintsUsed: 0 });
    const messy = computeScore({ difficulty: 'hard', timeSeconds: 99999, mistakes: 2, hintsUsed: 3 });
  ...
  it('total never drops below 10% of base', () => {
    const s = computeScore({ difficulty: 'beginner', timeSeconds: 99999, mistakes: 99, hintsUsed: 99 });
