...
<template>
  <div class="grid grid-cols-5 gap-1.5 sm:gap-2 my-1">
    <!-- Undo -->
    <button
      @click="$emit('undo')"
    ...
    >
      <svg class="w-5 h-5 3xl:w-7 3xl:h-7 dark:text-zinc-400 text-zinc-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" />
      </svg>
      <span class="text-[10px] 3xl:text-xs font-semibold uppercase dark:text-zinc-400 text-zinc-600">{{ $t('controls.undo') }}</span>
    </button>
    ...
    >
      ...
      <span class="text-[10px] 3xl:text-xs font-semibold uppercase dark:text-zinc-400 text-zinc-600">{{ $t('controls.erase') }}</span>
    </button>
    ...
    >
      ...
      <span class="text-[10px] 3xl:text-xs font-semibold uppercase" :class="notesMode ? 'text-violet-400' : 'dark:text-zinc-400 text-zinc-600'">{{ $t('controls.notes') }}</span>
    </button>
    ...
    >
      <svg class="w-5 h-5 3xl:w-7 3xl:h-7 dark:text-amber-400 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
      </svg>
      <span class="text-[10px] 3xl:text-xs dark:text-amber-400 text-amber-700 font-bold uppercase">{{ $t('controls.hint') }}</span>
    </button>
    ...
    >
      ...
      <span class="text-[10px] 3xl:text-xs font-semibold uppercase">{{ $t('controls.auto') }}</span>
    </button>
  </div>
</template>
