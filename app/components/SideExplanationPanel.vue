...
<template>
  <div class="w-full border p-4 flex flex-col select-none dark:bg-zinc-900/40 dark:border-zinc-800 bg-zinc-50 border-zinc-200 3xl:mt-12">
    ...
    <div v-if="!activeComplexHint" class="flex flex-col items-center justify-center text-center p-6 py-10">
      <div class="p-3 border text-zinc-500 mb-4 dark:bg-zinc-800 dark:border-zinc-700 bg-zinc-100 border-zinc-300">
        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
        </svg>
      </div>
      <h3 class="text-sm 3xl:text-base font-bold uppercase tracking-wider dark:text-zinc-400 text-zinc-600">{{ $t('hint.panelTitle') }}</h3>
    ...
    <div v-else class="flex flex-col gap-4">
      ...
      <!-- Legend -->
      <div class="border-t pt-3 space-y-1.5 text-xs 3xl:text-sm font-medium text-zinc-500 dark:border-zinc-800/60 border-zinc-200">
      ...
      <div class="flex flex-col gap-2 border-t pt-3 dark:border-zinc-800 border-zinc-200">
        <div class="grid grid-cols-2 gap-2">
          <button
            ...
            :class="currentStepIndex === 0 ? 'opacity-30 pointer-events-none' : 'dark:hover:bg-zinc-800 hover:bg-zinc-100 dark:text-zinc-200 text-zinc-800'"
